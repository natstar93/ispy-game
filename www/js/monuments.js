var monuments = [
  { name: 'The Shard',
           ...
           image: 'img/cameraview/shard.png',
           map: 'img/cameraview/shard_map.png',
           icon:'img/shard_icon.gif',
           longitude: 51.5045,
           latitude: -0.0865
          },
  { name: 'Black Cab',
          ...
          image: 'img/cameraview/taxi.png',
          map: 'img/cameraview/london_map.png'
        },
  { name: 'Big Ben',
            index: 2,
            points: 30,
            ...
            image: 'img/cameraview/big_ben.png',
            map: 'img/cameraview/big_ben_map.png',
            icon:'img/big_ben_icon.gif',
            longitude: 51.5008,
            latitude: -0.1247
          },
   { name: 'Tower Bridge',
            ...
            image: 'img/cameraview/bridge.png',
            map: 'img/cameraview/bridge_map.png',
            icon:'img/tower_bridge_icon.gif',
            longitude: 51.5056,
            latitude: -0.0756
          },
  { name: 'Big Red Bus',
   ...
   { name: 'London Eye',
            ...
            image: 'img/cameraview/london_eye.png',
            map: 'img/cameraview/london_map.png',
            icon:'img/london_eye_icon.gif',
            longitude: 51.5033,
            latitude: -0.1197
          },
  ...
  { name: 'The Gherkin',
            ...
            image: 'img/cameraview/axe.png',
            map: 'img/cameraview/axe_map.png',
            icon:'img/gherkin_icon.gif',
            longitude: 51.5144,
            latitude: -0.0803
          },
